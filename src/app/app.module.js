...
(function () {
    ...
    app.config(function ($stateProvider, $locationProvider, $urlRouterProvider, RestangularProvider, CONFIG, $translateProvider, tmhDynamicLocaleProvider) {
        $urlRouterProvider
            .when('/', '/main')
            .otherwise('/');
    ...
    app.run(function ($rootScope, tmhDynamicLocale, Restangular, Flash) {
